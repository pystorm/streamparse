...
htmlhelp_basename = 'streamparse' + release.replace('.', '_')
...
latex_documents = [
  ('index', 'streamparse.tex', u'streamparse Documentation',
   u'Parsely', 'manual'),
]
...
man_pages = [
    ('index', 'streamparse', u'streamparse Documentation',
     [u'Parsely'], 1)
]
...
texinfo_documents = [
  ('index', 'streamparse', u'streamparse Documentation',
   u'Parsely', 'streamparse', 'Run Python on real-time streams of data.',
   'Miscellaneous'),
]
